 ...
 * Sweep de estrategias scalping (TPs ajustados) sobre NAS100 con walk-forward.
 */
...
console.log('🧪 SCALPING SWEEP · NAS100 · IS vs OS\n');
...
console.log('\n\n' + '═'.repeat(125));
console.log('📊 SCALPING SWEEP · NAS100 · in-sample vs out-of-sample');
