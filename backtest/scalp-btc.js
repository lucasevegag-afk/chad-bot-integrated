 ...
 * Sweep de estrategias scalping (TPs ajustados) sobre BTC/USDT con walk-forward.
 */
...
console.log('🧪 SCALPING SWEEP · BTC/USDT · IS vs OS\n');
...
console.log('\n\n' + '═'.repeat(125));
console.log('📊 SCALPING SWEEP · BTC/USDT · in-sample vs out-of-sample');
