 ...
 * Sweep de estrategias scalping (TPs ajustados) sobre AUDUSD con walk-forward.
 */
...
function runOne(env) {
  const child = spawnSync('node', [path.join(__dirname, 'run.js'), 'AUDUSD'], { env, encoding: 'utf8' });
...
console.log('🧪 SCALPING SWEEP · AUDUSD · IS vs OS\n');
...
console.log('\n\n' + '═'.repeat(125));
console.log('📊 SCALPING SWEEP · AUDUSD · in-sample vs out-of-sample');
