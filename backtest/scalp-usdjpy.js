 ...
 * Sweep de estrategias scalping (TPs ajustados) sobre USDJPY con walk-forward.
 */
...
console.log('🧪 SCALPING SWEEP · USDJPY · IS vs OS\n');
...
console.log('\n\n' + '═'.repeat(125));
console.log('📊 SCALPING SWEEP · USDJPY · in-sample vs out-of-sample');
