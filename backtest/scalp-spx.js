 ...
 * Sweep de estrategias scalping (TPs ajustados) sobre SPX500 con walk-forward.
 */
...
console.log('🧪 SCALPING SWEEP · SPX500 · IS vs OS\n');
...
console.log('\n\n' + '═'.repeat(125));
console.log('📊 SCALPING SWEEP · SPX500 · in-sample vs out-of-sample');
