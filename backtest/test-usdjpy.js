 ...
 * Test estrategias del registry sobre USDJPY.
 */
...
function runOne(env) {
  const child = spawnSync('node', [path.join(__dirname, 'run.js'), 'USDJPY'], { env, encoding: 'utf8' });
...
console.log('🧪 TESTING 5 STRATEGIES ON USDJPY\n');
...
console.log('\n\n' + '═'.repeat(120));
console.log('📊 USDJPY — transferencia de estrategias');
