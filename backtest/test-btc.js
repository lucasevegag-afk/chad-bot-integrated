/**
 * backtest/test-btc.js
 * Corre las 4 estrategias del registry sobre BTCUSDT.
 */
...
console.log('🧪 TESTING 4 STRATEGIES ON BTCUSDT (522k velas M5)\n');
...
console.log('\n\n' + '═'.repeat(120));
console.log('📊 BTCUSDT vs XAU/USD — transferencia');
...
console.log(
  ...
  '  │  ' +
  'BTC Trades'.padStart(12) +
  'BTC WR IS'.padStart(11) +
  'BTC WR OS'.padStart(11) +
  'BTC TotR'.padStart(10) +
  'BTC DD'.padStart(9) +
  'BTC Decay'.padStart(11) +
  '  Verdict'
);
console.log('─'.repeat(120));
