 ...
 * Sweep de estrategias scalping (TPs ajustados) sobre GBPUSD con walk-forward.
 */
...
function runOne(env) {
  const child = spawnSync('node', [path.join(__dirname, 'run.js'), 'GBPUSD'], { env, encoding: 'utf8' });
...
console.log('🧪 SCALPING SWEEP · GBPUSD · IS vs OS\n');
...
console.log('\n\n' + '═'.repeat(125));
console.log('📊 SCALPING SWEEP · GBPUSD · in-sample vs out-of-sample');
