 ...
 * Sweep de estrategias scalping (TPs ajustados) sobre GBPAUD con walk-forward.
 */
...
function runOne(env) {
  const child = spawnSync('node', [path.join(__dirname, 'run.js'), 'GBPAUD'], { env, encoding: 'utf8' });
...
console.log('🧪 SCALPING SWEEP · GBPAUD · IS vs OS\n');
...
console.log('\n\n' + '═'.repeat(125));
console.log('📊 SCALPING SWEEP · GBPAUD · in-sample vs out-of-sample');
