 ...
 * Sweep de estrategias scalping (TPs ajustados) sobre XAU/USD con walk-forward.
 */
...
function runOne(env) {
  const child = spawnSync('node', [path.join(__dirname, 'run.js'), 'XAUUSD'], { env, encoding: 'utf8' });
...
console.log('🧪 SCALPING SWEEP · XAU/USD · IS vs OS\n');
...
console.log('\n\n' + '═'.repeat(125));
console.log('📊 SCALPING SWEEP · XAU/USD · in-sample vs out-of-sample');
