 ...
 * Sweep de estrategias scalping (TPs ajustados) sobre USDCAD con walk-forward.
 */
...
console.log('🧪 SCALPING SWEEP · USDCAD · IS vs OS\n');
...
console.log('\n\n' + '═'.repeat(125));
console.log('📊 SCALPING SWEEP · USDCAD · in-sample vs out-of-sample');
